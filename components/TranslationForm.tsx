...
import { Textarea } from "./ui/textarea";//this is for text area boostrap
import {
  Select,
  SelectContent,
  SelectGroup,
  ...
  SelectTrigger,
  SelectValue,
} from "@/components/ui/select";//this is for dropdown from list
        ...
        <div className="flex flex-col space-y-2 lg:flex-row lg:space-y-0 lg:space-x-2">
          <div className="flex-1 space-y-2">
            <Select name="inputLanguage" defaultValue="auto">
              {/* the default value is auto because the language we are typing should be detected automatically */}
...
{/* This is for entering the text we want to translate and taken as input here */}
            <Textarea
              ...
              // we are using server action to convert it
            />
          </div>
          ...
          <div className="flex-1 space-y-2">
            <div className="flex items-center justify-between">
              <Select name="outputLanguage" defaultValue="es">
                {/* the default langauage shauld be converted to english */}
                <SelectTrigger className="w-[280px] border-none text-blue-500 font-bold">
                  <SelectValue placeholder="Select a language" />
                </SelectTrigger>
